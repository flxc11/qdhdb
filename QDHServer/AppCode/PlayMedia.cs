...
namespace QDHServer.AppCode
{
    public class PlayMedia
    {
        public static string Play(string url, int width, int height)
        {
            ...
            if (strTmp.EndsWith(".wmv") || strTmp.EndsWith(".mp3") || strTmp.EndsWith(".wma") || strTmp.EndsWith(".avi") || strTmp.EndsWith(".asf") || strTmp.EndsWith(".mpg") || strTmp.EndsWith(".rmvb") || strTmp.EndsWith(".mp4") || strTmp.EndsWith(".mkv"))
            {
            ...
            else if (strTmp.EndsWith(".jpg") || strTmp.EndsWith(".gif") || strTmp.EndsWith(".png"))
            {
