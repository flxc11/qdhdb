<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TerminalManagement.aspx.cs"
    Inherits="QDHServer.ad.TerminalManagements.TerminalManagements.TerminalManagement" %>
            ...
            <tr>
                <td colspan="4">
                    <asp:GridView ID="gvTerminalManagement" runat="server" AutoGenerateColumns="False"
                        ...
                        OnRowUpdating="gvTerminalManagement_RowUpdating" OnRowDataBound="gvTerminalManagement_RowDataBound">
                        <Columns>
