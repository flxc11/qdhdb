<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsInfoAdd.aspx.cs" Inherits="QDHServer.news.NewsInfo.NewsInfoAdd" %>
...
<div class="navigation">当前位置：&nbsp;信息管理 &gt; 添加信息</div>
<div id="contentTab">
<ul class="tab_nav">
...
<td style="width:35%"><input type="file" class="txtInput" name="TxtNewsLogourl" /></td>
...
&nbsp;<input type="button" class="btnSubmit" value="返 回" onclick="window.location.href='newsinfolist.aspx'"/></td>
</tr>
</tbody>
</table>
</div>
