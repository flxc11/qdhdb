<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CmsImagesAdd.aspx.cs" Inherits="QDHServer.news.Operate.CmsImagesAdd" %>
...
a.files {
	...
	background:url(../Images/BtnAddFile.gif) left top no-repeat;
...
<body>
<form id="form1" name="form1" method="post" action="?Action=Save&ParentID=<%=Request.Params["ParentID"]%>">
...
<td><a href="javascript:void(0);" class="files" id="idFile"></a> <img id="idProcess" style="display:none;" src="../Images/Loading1.gif" /></td>
</tr>
<tr>
...
<tr>
<td colspan="2" align="center" id="idMsg"><input type="button" value="开始上传" id="idBtnupload" disabled="disabled" class="pop_button" /> <input type="button" value="全部取消" id="idBtndel" disabled="disabled" class="pop_button"/> <input type="button" value="返回前页" id="idBtnBack" class="pop_button" onclick="history.back();"/>
</td>
</tr>
</tbody>
</table>
...
<script type="text/javascript">
    ...
    var fu = new FileUpload("form1", "idFile", {
        Limit: 6, ExtIn: ["jpg", "jpeg", "gif", "png", "bmp"],
    ...
    $("idBtnupload").onclick = function () {
        ...
        $("idMsg").innerHTML = "正在将文件上传到服务器中，请稍候……<br />有可能因为网络问题，出现程序长时间无响应，请点击“<a href='?'><font color='red'>取消</font></a>”重新上传文件";
    ...
    function Finish(msg) { alert(msg); window.location.href = 'CmsImages.aspx'; /*top.MainFrame.location.reload();top.removeTB();*/ }
</script>
</body>
</html>
